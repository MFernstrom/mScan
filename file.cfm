...
<cfset complexity = createObject("component","utils.CFComplexityAppDriver").init()>

<cfset complexityReport = complexity.getFileComplexityReport(url.file) />
...
<cfif complexityReport.hasFunctions()>
	...
	<table class="functions">
		...
		<cfoutput query="functions">
			<tr>
				<td><a href="function.cfm?directory=#url.directory#&file=#url.file#&function=#name#" class="mono">#name# ()</a></td>
				<td>#Lines#</td>
				<td>#complexity#</td>
			</tr>
		</cfoutput>
...
<!--- <img src="dragon.png" style="float:right;" /> --->